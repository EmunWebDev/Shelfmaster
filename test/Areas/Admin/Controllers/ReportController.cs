        ...
        public async Task<IActionResult> ExportToPdf(int transactionId)
        {
            ...
            var pdfBytes = Document.Create(container =>
            {
                container.Page(page =>
                {
                        ...
                        if (transaction.Penalty != null && transaction.Penalty.Any())
                        {
                            ...
                            col.Item().Table(table =>
                            {
                                ...
                                foreach (var penalty in transaction.Penalty)
                                {
                                    ...
                                    table.Cell().Text($"{penalty.Amount:C2}");
                                ...
                                table.Cell().Text($"Total: {totalPenalty:C2}").Bold();
                    ...
                    page.Footer()
                        .AlignCenter()
                        .Text("Generated by BookHaven Library System - " + DateTime.Now.ToString("yyyy-MM-dd HH:mm"))
                        .FontSize(10)
                        .Italic();
                });
            }).GeneratePdf();
